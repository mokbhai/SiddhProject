 ...
 * @const
 * @type {!grpc.web.MethodDescriptor<
 *   !proto.calculator.MultiplyRequest,
 *   !proto.calculator.MultiplyResponse>}
 */
const methodDescriptor_Calculator_Multiply = new grpc.web.MethodDescriptor(
  ...
  proto.calculator.MultiplyResponse,
  /**
   * @param {!proto.calculator.MultiplyRequest} request
   * @return {!Uint8Array}
   */
  function(request) {
    return request.serializeBinary();
  },
  proto.calculator.MultiplyResponse.deserializeBinary
);


/**
 * @param {!proto.calculator.MultiplyRequest} request The
 *     request proto
 * @param {?Object<string, string>} metadata User defined
 *     call metadata
 * @param {function(?grpc.web.RpcError, ?proto.calculator.MultiplyResponse)}
 *     callback The callback function(error, response)
 * @return {!grpc.web.ClientReadableStream<!proto.calculator.MultiplyResponse>|undefined}
 *     The XHR Node Readable Stream
 */
 ...
 * @param {?Object<string, string>=} metadata User defined
 *     call metadata
 * @return {!Promise<!proto.calculator.MultiplyResponse>}
 *     Promise that resolves to the response
 */
